...
test.describe('Welcome Component', () => {
  ...
  test('Welcome Page Display', async ({ Given, Then, And, page }) => { 
    ...
    await And('I should see links to "Configurator" and "Documentation"', null, { page }); 
